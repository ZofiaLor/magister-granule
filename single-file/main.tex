...
\begin{itemize}
	...
	\item Algorytmy oparte na partycjonowaniu: związane z iteracyjnym wyznaczaniem środków klastrów do momentu spełnienia kryterium zatrzymania.
	\item Algorytmy rozmyte: przyjmują, że każdy element może być częścią wielu klas z pewnym stopniem przynależności.
	\item Algorytmy oparte o rozkład danych
	\item Algorytmy gęstościowe: obszary o dużej gęstości danych tworzą klastry, pozostałe uznawane są za szumy
	\item Algorytmy grafowe
	\item Algorytmy siatkowe
	\item Algorytmy fraktalne
	\item Algorytmy modelowe: dla każdej klasy znajdowany jest najlepszy model.
\end{itemize}
