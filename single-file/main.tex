...
Proces hierarchicznego scalania (lub rozdzielania) klastrów można zwizualizować jako dendrogram (rys. \ref{fig:dendrogram-iris}). 
...
Wykorzystana miara dokładności przyjmuje, że algorytm ostry, dla łączności \english{single linkage}, posiada dokładność 100\% -- każdy punkt zostaje przypisany do oczekiwanego klastra.
