...
W tabeli \ref{id:tab:zbiory} przedstawiono charakterystykę wykorzystanych kształtów zbiorów danych.
\ksremark{rysunek z przykładami tych zbiorów}
...
\toprule
	& blobs & circles & crescents & corners & laguna & spheres \\
\midrule
	    liczba klastrów & 3 & 2 & 2 & 4 & 3 & 2 \\
	    liczba wymiarów & 2 & 2 & 2 & 2 & 2 & 3 \\
	    % opis & obiekty wygenerowane funkcją sklearn.datasets.make_blobs o proporcji rozmiarów 48:1:1 & okręgi wygenerowane funkcją sklearn.datasets.make_circles, mniejszy okrąg wewnątrz większego & łuki wygenerowane funkcją sklearn.datasets.make_moons & cztery obiekty, z których każdy składa się z dwóch nachodzących na siebie prostokątnych obiektów & dwa koliste obiekty otoczone wycinkiem okręgu & dwie sfery, mniejsza zawarta w większej \\
\bottomrule
\end{tabular}
\end{table}  
...
\toprule
	& blobs & circles & crescents & corners & laguna & spheres \\
\midrule
	    dokładność & 97,931\% & 87,911\% & 99,915\% & 80,708\% & 79,749\% & 97,210\% \\
\bottomrule
\end{tabular}
\end{table}  
