...
\ksremark{No i tutaj dajemy pseudokod – coś w styku alg. \ref{alg:cascade_inference}.}
...
\caption{Dendrogram otrzymany na podstawie grupowania hierarchicznego o łączności \english{single linkage} przykładowego zbioru danych ,,\english{iris}'' \ksremark{\iris}.}
