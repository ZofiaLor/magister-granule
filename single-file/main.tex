...
Algorytm dla łączności \CompleteLinkage{} nie odnajduje poprawnie klastrów, co widać na rys. \todo{rysunek circles, analiza kształtu dla cl}. Badane parametry nie mają znacznego wpływu na jakość.
...
\begin{figure}
\centering
\includegraphics{./img/brightkite_nonfuzzy.png}
...
\begin{figure}
\centering
\includegraphics{./img/brightkite_fuzzy.png}
